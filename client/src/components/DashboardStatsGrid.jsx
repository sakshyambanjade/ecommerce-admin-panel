...
import { IoBagHandle, IoPieChart, IoPeople, IoCart , IoTrendingUpOutline} from 'react-icons/io5'
	...
	return (
		<div className="flex gap-4">
			...
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Monthly Target</span>
					<div className="flex items-center">
